...
<!-- ************************************************************************************************************************
 -->
  ...
  <span class="input-group-text" style="border: none;" ><b><h5>Ingrese Cédula / Pasaporte </h5></b></span>
  <input
              type="text"
              class="form-control"
...
<div class="table-responsive">
  ...
  <li  class="list-group-item ">
    ...
    <form class="row g-3 mb-3" >
          ...
          <div class="col-md-3 d-none" id="container_heredo" >
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////// -->
  ...
  <li  class="list-group-item ">
    ...
    <form class="row g-3 mb-3" >
          ...
          <div class="col-md-3 d-none" id="container_enfe_cronica_pat">
            <label for="validationCustom01" class="form-label"><strong>¿Cuales?</strong></label>
            <div class="container">
                <div class="row">
                <div class="form-check">
...
<li  class="list-group-item ">
  ...
  <li  class="list-group-item ">
    ...
    <div class="col-md-2">
          ...
          <div class="col-md-3 my-3 d-none" style="background-color: #F2F4F4;"  id="seleccionBiopsia">
            <label for="validationCustom05" class="form-label "
              >Fecha:</label>
          <input type="date" name="" id="fecha_biopsia" class="form-control">
          <label for="validationCustom05" class="form-label my-3"
              >Resultado:</label>
          <textarea type="text" name="" id="resultado_biopsia" class="form-control "> </textarea>
          </div>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
      <div>
       ...
       <hr id="linea">
       <a href="examenes.php" id="menu-extra">Examen Físico</a>
       <hr id="linea">
       <a href="evolucion_paciente.php" id="menu-extra">Expediente</a>
       <hr id="linea">
      </div>
...
<script src="../js/historia_clinica/select.js"></script>
<script src="../js/historia_clinica/historia_clinica.js"></script>
  <script
