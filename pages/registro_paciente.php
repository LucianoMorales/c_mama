...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../style/style_seccion.css">
...
<!-- ARREGLAR LÑA LINEA DEBAJOOOOO DEL COSITO Y BORRAR LA LINEA FEA.  -->
  ...
  <hr>
        ...
        <div class="col-md-3">
            <label for="validationCustom01" class="form-label">Cédula / pasaporte: </label>
            <input
              type="text"
              class="form-control"
              id="cedula"
          ...
          <div class="col-md-2">
            <label for="validationCustom01" class="form-label">Teléfono de casa</label>
            <input
              type="text"
              class="form-control"
              id="telefono"
          ...
          <div class="col-md-5 my-3">
            <label for="validationCustom05" class="form-label">Comunidad</label>
            <input
              type="text"
              class="form-control"
              id="comunidad"
...
<!-- /////////////////////////////////////////////////////////////////////////////////// -->
          ...
          <div class="section">
          <h6>Otros Contactos (Familiar acompañante)</h6>
           <hr>
          </div>
...
<!-- ///////////////////////////////////////////////////// -->
        ...
        <div class="col-5">
          <!-- <button type="submit" class="btn btn-info" id="examenfisico"  data-bs-toggle="modal" data-bs-target="#examen_fisico" >
            Examen Fisíco
          </button> -->
        </div>
      ...
      <div class="col-3">
            ...
            <button class="btn btn-primary" id="datos_pacientes" 
...
"></script>
    ...
    <script src="../js/cargar_datos_provincias.js"></script>
<script src="../js/registro_paciente/registro_paciente.js"></script>
