...
<div class="row">
        ...
        <div class="row gap-0 column-gap-3">
          ...
          <div class="col-sm-7 shadow-lg p-3 mb-5 bg-body-tertiary rounded" id ="tabla-paciente" >
            ...
            <div class="d-flex flex-row-reverse"   id="menu-pac-total" >
              ...
              <div class="p-2">
              <button type="button" id="btn-add-new" class="btn btn-success"
              ...
              <table class="class= table table-borderless" id="tabla-datos">
                <thead>
                  <tr>
                    ...
                    <th>Base cáncer de piel</th>
                    <th>Bd Cáncer de mama
  ...
  <div class="modal fade" id="info_paciente" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content" id="modalmodal" >
      <div class="modal-header" >
 
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body"  >
       <div class="container" id="cuerpo_info">

       </div>
      </div>
      <div class="col my-2"> <button  type="button" onclick="imprimir()" >Descargar</button> </div>
    </div>
