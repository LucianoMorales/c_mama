...
<link href="https://fonts.googleapis.com/css2?family=Bona+Nova&family=Merriweather&display=swap" rel="stylesheet">
  ...
  " rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="../style/user/estilo_menu.css">
  <!-- <link rel="stylesheet" type="text/css" href="../../style/estilo_menu_p.css"> -->
  <link rel="stylesheet" href="../style/user/estilo_buscarpaciente.css" />
 <link rel="stylesheet" href="../style/user/formulario.css">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="rol_edit" placeholder="">
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="rol_add" placeholder="">
            </div>
          
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
            <button type="button" class="btn btn-success" id="btn_nuevo_rol">Agregar </button>
          </div>
        </div>
      </div>
    </div>
