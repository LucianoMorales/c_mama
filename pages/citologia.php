    ...
    <div class="container-fluid" id="menu-container" >
      ...
      <div class="row d-flex justify-content-center "  >
        ...
        <div class="col-sm-12 col-md-12 text-center my-3">
          <h1>SOLICITUD PARA EVALUACIÓN CITOLOGICA</h1>
    <hr>
        </div>
        </div>
...
<div class="col-sm-12 ">
 ...
 <div class="col-sm-3">Fecha de toma
   ...
   <div class="col-sm-4 my-3">
    ...
    <textarea type="text" name="" id="examen_cito" class="form-control"> </textarea>
   </div>
   <!-- <div class="col-sm-2 my-3">
    Atendida por: 
...
<textarea type="text" name="" id="comentarios_cito" class="form-control"> </textarea>
     ...
     <div class="col-md-7">   
      ...
      <div class="row my-1">
        ...
        <div class="col-md-5 border"><strong>DIBUJO 1</strong></div>
      </div>
      <div class="row my-1">
      ...
      <div class="row my-3">
        <div class="col-md-5 border" style="background-color: red;"><strong>LEUCOPLASIA</strong></div>
     ...
     <div class="col-md-7">   <table class="table">
      ...
      <div class="col-sm-12 my-3 justify-content-right">
      <div class="col-sm-3 ">
          
      <button class="btn btn-success" id="send_date_cito" 
...
"></script>
  ...
  <script src="../js/citologia/citologia.js"></script>
