...
<div class="row">
 ...
 <div class="col-sm-3  text-right"> <label for="mesAnio" >Seleccionar Mes y Año:</label></div>
 <div class="col-sm-3">      
  <input type="month" id="mesAnio" name="mesAnio" class="form-control"></div>
  </div>
</div>
...
<div class="container text-center">
  <div class="row justify-content-md-center">
    <div class="col col-lg-2">
      <button class="form-control" id="download" >DESCARGAR</button>
    </div>
  </div>
</div>
